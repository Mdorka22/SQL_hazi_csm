...
CREATE TABLE Auto (
    ...
    oktato_id INT UNIQUE NOT NULL FOREIGN KEY REFERENCES Oktatok(id)
);

CREATE TABLE Ora_ara(
      id INT PRIMARY KEY,
      oktato_id INT FOREIGN KEY REFERENCES Oktatok(id),
...
CREATE TABLE Ora (
    id INT PRIMARY KEY,
    oktato_id INT FOREIGN KEY REFERENCES Oktatok(id),
    tanulo_id INT FOREIGN KEY REFERENCES Tanulok(id),
    idopont_id INT FOREIGN KEY REFERENCES Idopont(id)
);

CREATE TABLE Vizsga (
    id INT PRIMARY KEY,
    ora_id INT UNIQUE NOT NULL FOREIGN KEY REFERENCES Ora(id),
